...
3. Identify and read the relevant module from the repository's `knowledge/` directory. For texture-map tasks, read `knowledge/texture-maps.md`; for model and geometry import tasks, read `knowledge/geometry-import.md`; for animation import tasks, read `knowledge/animation-import.md`; for scene audit tasks, read `knowledge/scene-audit.md`; for materials and shader tasks, read `knowledge/materials-shaders.md`; for UV tasks, read `knowledge/uv.md`; for baking and lightmap tasks, read `knowledge/baking-lightmaps.md`; for VFX and particle tasks, read `knowledge/vfx-particles.md`; for LOD, culling, and streaming tasks, read `knowledge/lod-culling-streaming.md`; for reflection-source tasks, read `knowledge/reflection-sources.md`; for mesh-processing tasks, read `knowledge/mesh-processing.md`; for lighting and exposure tasks, read `knowledge/lighting-exposure.md`; for asset-validation tasks, read `knowledge/asset-validation.md`.
...
Knowledge modules are stored in the repository's `knowledge/` directory and are selected by technical-art problem category. The repository currently includes populated modules for texture maps, geometry import, animation import, scene auditing, materials/shaders, UVs, baking/lightmaps, VFX/particles, LOD/culling/streaming, reflection sources, mesh processing, lighting/exposure, and asset validation.

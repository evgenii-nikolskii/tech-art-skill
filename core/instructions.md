...
For texture-map tasks, use `knowledge/texture-maps.md`. For model and geometry import tasks, use `knowledge/geometry-import.md`. For animation import tasks, use `knowledge/animation-import.md`. For scene audit tasks, use `knowledge/scene-audit.md`. For materials and shader tasks, use `knowledge/materials-shaders.md`. For UV tasks, use `knowledge/uv.md`. For baking and lightmap tasks, use `knowledge/baking-lightmaps.md`. For VFX and particle tasks, use `knowledge/vfx-particles.md`. For LOD, culling, and streaming tasks, use `knowledge/lod-culling-streaming.md`. For reflection-source tasks, use `knowledge/reflection-sources.md`. For mesh-processing tasks, use `knowledge/mesh-processing.md`. For lighting and exposure tasks, use `knowledge/lighting-exposure.md`. For asset-validation tasks, use `knowledge/asset-validation.md`. If the relevant module is empty or does not yet provide relevant guidance, state that the knowledge is not yet populated and continue using only the general contract. Do not invent domain-specific rules and present them as repository knowledge.
